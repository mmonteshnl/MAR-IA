 ...
 *
 * - generateSolutionConfigurationEmail - Generates the email subject and body.
 * - GenerateSolutionConfigurationEmailInput - Input type.
 * - GenerateSolutionConfigurationEmailOutput - Output type.
 */
